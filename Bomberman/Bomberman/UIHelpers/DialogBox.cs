...
{
    //NOTE: This class is based on https://github.com/Andrux51/MonoGame-Tutorial-DialogBox/blob/master/MonoGame-Tutorial-DialogBox/DialogBox.cs
    //there are some changes specific to this project, but most of the code is the same
    public class DialogBox
    {
        ...
        /// The game object
        /// </summary>
        private Bomberman _game;

        /// <summary>
        /// Default constructor
        /// </summary>
        public DialogBox(Bomberman game)
        {
            _game = game;
            _characterSize = _game.DialogFont.MeasureString(new StringBuilder("W", 1));
            ...
            _borderTexture = new Texture2D(_game.GraphicsDevice, 1, 1);
            _borderTexture.SetData(new[] { BorderColor });

            _pages = new List<string>();
            _currentPage = 0;

            var sizeX = (int)(_game.GraphicsDevice.Viewport.Width * 0.5);
            var sizeY = (int)(_game.GraphicsDevice.Viewport.Height * 0.2);
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            if (Active)
            {
                ...
                spriteBatch.DrawString(_game.DialogFont, _pages[_currentPage], TextPosition, DialogColor);
